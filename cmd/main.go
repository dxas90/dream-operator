...
import (
	...
	"github.com/dxas90/dream-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "1975769e.devopsengineer.ing",
	...
	// Graceful shutdown https://github.com/dxas90/learn/blob/develop/main.go#L274
